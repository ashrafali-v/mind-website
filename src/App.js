...
function App() {
  ...
  function mark(key) {
    clearIt();
    if (key.length > 2) {
      let c = new RegExp(key, "ig");

      document.getElementById("main").innerHTML = document
        .getElementById("main")
        .innerHTML.replace(c, "<mark>" + key + "</mark>");
    }
  }
 ...
 ></input> */}
      ...
      <div className="flex flex-row max-lg:flex-col sm:h-auto max-[640px]:h-auto w-full h-96 bg-[#2B2B39] px-10 py-10">
        ...
        <div className="flex flex-col w-1/3 mb-10 text-white space-y-5 sm:ml-5 max-lg:w-full">
          <div className="font-sans normal font-semibold text-lg leading-7 text-white mt-5 text-start max-lg:text-center">
            Subscribe Cirkle Newsletter
          </div>
          <div className="font-sans normal font-normal text-lg leading-7 text-white mt-5 text-start max-lg:text-center">
